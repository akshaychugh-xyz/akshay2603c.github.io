...
Before creating the post file, ask the user: "Do you want to send this post to your newsletter subscribers?" If yes, add `newsletter: true` to the frontmatter. If no, do not add the newsletter field. 
